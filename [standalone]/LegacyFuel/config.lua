...
Config.Strings = {
	CancelFuelingPump = "Tryck på ~b~E ~w~för att avbryta tankningen",
	CancelFuelingJerryCan = "Tryck på ~b~E ~w~för att avbryta tankningen",
	CancelSiphoningFuel = "Tryck på ~b~E ~w~ för att avbryta sugning av bränsle"
}
