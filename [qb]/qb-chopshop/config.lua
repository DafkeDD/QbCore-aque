...
Config.Locale = {
    -- Notifications
    ["Reminder"] 			= "Ta bort delar från fordonet och sedan så krossar du för att tjäna saker!",
	["FarAway"] 			= "Du är för långt borta från fordonet. Den har skickats till krossen!",
    ["CoolDown"]            = "Det finns för närvarande inga nya jobb, kom gärna tillbaka senare!",
    ["JobActive"]           = "Du har inte slutfört det aktiva jobbet ännu!",
    ["Email"]               = "Jag skickar information till din e-post.",
    ["WrongVeh"]            = "Detta är inte rätt fordon",
    ["FoundVeh"]            = "Bra, du hittade rätt bil!",
    ["ScrapBlip"]           = "Skickar skrotplatsen till din GPS...",


    -- Draw Text
    ["chop"] 			    = "~g~E~w~ - Börja ta bort delar",
	["remove"] 				= "~g~E~w~ - Ta bort ",
	["destroy"] 			= "~g~E~w~ - Förstör fordonet ",
    ["reqjob"] 			    = "~g~E~w~ - Begär fordonsinformation.",
	["Trunk"]				= "Bagage",				
	["Hood"]				= "Huv",				
	["Frontleftdoor"]		= "vänster framdörr",	
	["Backleftdoor"]		= "vänster bakdörr",		
	["Frontrightdoor"]		= "höger framdörr",	
	["Backrightdoor"]		= "höger bakdörr",	
	["Frontleftwheel"]		= "vänster framhjul",	
	["Backleftwheel"]		= "bakre vänstra hjulet",	
	["Rightfrontwheel"]		= "höger framhjul",	
	["Rightbackwheel"]		= "bakre högra hjulet",	

    -- Progress Bars
    ["Wheel"] 				= "Ta bort hjulet...",
	["Door1"] 		        = "Lossar bultar...",
	["Door2"] 		        = "Drar bort delen..",
	["crushing"] 			= "Skickar bil till krossen",
    ["searching"]           = "Letar i bagaget...",

    ["chopwheel"]           = "Skär ner hjulet..",
    ["chopdoor"]           = "Skär ner dörren..",
    ["choptrunk"]           = "Skär ner stammen..",
    ["chophood"]           = "Skär ner huven..",
}
