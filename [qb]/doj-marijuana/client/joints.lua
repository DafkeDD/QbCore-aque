...
RegisterNetEvent('doj:client:smokeJoint', function(prop_name)
    ...
    if IsPedSittingInAnyVehicle(playerPed) then
		QBCore.Functions.Notify("Kan inte röka detta när du är inne i ett fordon", "error", 3500)
        return
    end
    QBCore.Functions.Progressbar("smoking", "Röker en joint...", 10000, false, true, {
...
AddEventHandler('doj:client:smokeJoint3g', function(source)
	...
	inJoint = true
    QBCore.Functions.Notify("Tänder...", "success", 3700)
