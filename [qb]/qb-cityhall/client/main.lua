...
RegisterNetEvent('qb-cityhall:client:sendDriverEmail', function(charinfo)
    SetTimeout(math.random(2500, 4000), function()
        ...
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            sender = "Township",
            subject = "Körlektioner",
            message = "Hej " .. gender .. " " .. charinfo.lastname .. ",<br /><br />Vi har precis fått ett meddelande om att någon vill ta körlektioner<br />Om du är villig att undervisa, vänligen kontakta oss:<br />Naam: <strong>".. charinfo.firstname .. " " .. charinfo.lastname .. "</strong><br />Phone Number: <strong>"..charinfo.phone.."</strong><br/><br/>Kind regards,<br />Township Los Santos",
            button = {}
        })
    end)
end)
...
RegisterNUICallback('applyJob', function(data)
    if inRange then
        ...
        QBCore.Functions.Notify('Fungerar tyvärr inte...', 'error')
    end
end)
