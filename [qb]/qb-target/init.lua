...
Config.Peds = {
	{  -------vapenskåp------
	model = `s_m_m_armoured_0`,
	coords = vector4(480.31, -996.62, 30.69, 93.95),
	gender = 'male',
	freeze = true,
	invincible = true,
	blockevents = true,
	...
	-- Arbetsförmedlingen
{
	...
	coords = vector4(116.97, -747.33, 45.75, 119.71),
	gender = 'male',
	freeze = true,
	invincible = true,
	blockevents = true,
  ...
  -- Blackmarket
{
	...
	coords = vector4(722.71, 4190.27, 41.09, 182.03),
	gender = 'male',
	freeze = true,
	invincible = true,
	blockevents = true,
	...
	-- Polisgarage 1
{
	...
	coords = vector4(460.11, -986.74, 24.7, 93.47),
	gender = 'male',
	freeze = true,
	invincible = true,
	blockevents = true,
...
{
	model = 'csb_trafficwarden',
	coords = vector4(441.45, -987.65, 24.7, 176.98),
	gender = 'male',
	freeze = true,
	invincible = true,
	blockevents = true,
