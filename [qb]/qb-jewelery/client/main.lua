...
local function smashVitrine(k)
    if not firstAlarm then
        TriggerServerEvent('police:server:policeAlert', 'Misstänkt aktivitet')
        firstAlarm = true
    end
    ...
    QBCore.Functions.TriggerCallback('qb-jewellery:server:getCops', function(cops)
        if cops >= Config.RequiredCops then
            ...
            QBCore.Functions.Progressbar("smash_vitrine", Lang:t('info.progressbar'), Config.WhitelistedWeapons[pedWeapon]["timeOut"], false, true, {
                ...
                TriggerServerEvent('police:server:policeAlert', 'Rån pågår')
                smashing = false
...
CreateThread(function()
    ...
    AddTextComponentSubstringPlayerName("Juvel Butik")
