...
RegisterServerEvent('qb-carthief:Payout')
AddEventHandler('qb-carthief:Payout', function(Payout, arg, CarLabel)	
...
-- QBCore.Functions.CreateCallback('qb-carthief:PoliceOnDuty', function(source, cb)
--     police = 0
