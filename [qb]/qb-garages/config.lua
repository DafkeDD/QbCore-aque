...
Garages = {
    ...
    ["cartel"] = {
        label = "Cartel",
        takeVehicle = vector3(-1522.18, 855.92, 181.62),
        spawnPoint = vector4(-1523.19, 860.43, 181.65, 340.23),
        putVehicle = vector3(-1523.0, 860.95, 181.65),
        showBlip = false,
        blipName = "Cartel",
        blipNumber = 357,
        type = 'gang',                --public, job, gang, depot
    ...
    ["police"] = {
        label = "Police",
        takeVehicle = vector3(459.96, -986.68, 25.7),
        spawnPoint = vector4(452.23, -988.56, 25.7, 179.35),
        putVehicle = vector3(452.23, -988.56, 25.7),
        showBlip = false,
        blipName = "Police",
        blipNumber = 357,
