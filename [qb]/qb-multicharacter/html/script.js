...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        ...
        '<div class="character-info-box"><span id="info-label">Namn: </span><span class="char-info-js">'+cData.charinfo.firstname+' '+cData.charinfo.lastname+'</span></div>' +
        '<div class="character-info-box"><span id="info-label">Föddelsedags Datum: </span><span class="char-info-js">'+cData.charinfo.birthdate+'</span></div>' +
        '<div class="character-info-box"><span id="info-label">Kön: </span><span class="char-info-js">'+gender+'</span></div>' +
        ...
        '<div class="character-info-box"><span id="info-label">Jobb: </span><span class="char-info-js">'+cData.job.label+'</span></div>' +
        '<div class="character-info-box"><span id="info-label">Pengar: </span><span class="char-info-js">&#36; '+cData.money.cash+'</span></div>' +
