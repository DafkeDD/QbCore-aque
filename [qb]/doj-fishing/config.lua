...
Config.BoatSpawnLocation = {
	...
	Odeon 	= vector4(4769.75, -4783.78, 3.41, 148.75),        
}
Config.PlayerReturnLocation = {
	...
	AlamoSea 	= vector4(1301.1, 4233.696, 33.909, 337.548),
	Odeon 	= vector4(4764.1, -4779.82, 4.06, 64.75),              
}

-- Gear
Config.fishingRodPrice = 250                                     -- Price of a fishing rod
...
Config.flounderPrice     = 35                                   -- Price of Flounder
Config.stingrayPrice     = 35                                   -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = 75                                  -- Price of Dolphins
Config.sharktigerPrice   = 100                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 125                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 150                                  -- Price of Killer whales

-- Rewards
Config.smallLootboxCash = 150                                  	-- Price of the cash reward for the "Metal Box"
...
Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua qb-target exports)
	...
	{
		model = "a_m_m_hillbilly_01",                            -- Boat/Gear Menu
		coords = vector3(4763.5, -4781.0, 2.8),               
		heading = 146.98,
		gender = "male",
        scenario = "WORLD_HUMAN_STAND_FISHING"
	},
