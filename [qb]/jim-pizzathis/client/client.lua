...
CreateThread(function()
	...
	exports['qb-target']:AddBoxZone("PizzBase", vector3(811.42, -754.55, 26.78), 0.4, 0.4, { name="PizzBase", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.18, }, 
		{ options = { {  event = "jim-pizzathis:Menu:PizzaBase:Check", icon = "fas fa-pizza-slice", label = "Prepare Pizza", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzOven", vector3(808.28, -761.19, 26.78), 2.8, 0.7, { name="PizzOven", heading = 0.0, debugPoly=Config.Debug, minZ = 26.18, maxZ = 27.38, }, 
		{ options = { {  event = "jim-pizzathis:Menu:Oven:Check", icon = "fas fa-temperature-high", label = "Use Oven", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzChop", vector3(810.45, -765.17, 26.78), 0.6, 0.6, { name="PizzChop", heading = 0.0, debugPoly=Config.Debug, minZ = 26.18, maxZ = 27.38, }, 
		{ options = { {  event = "jim-pizzathis:Menu:ChoppingBoard:Check", icon = "fas fa-utensils", label = "Use Chopping Board", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzBurner", vector3(814.05, -752.89, 26.78), 2.4, 1.2, { name="PizzBurner", heading = 0.0, debugPoly=Config.Debug, minZ = 25.98, maxZ = 27.98, }, 
		{ options = { {  event = "jim-pizzathis:Menu:PizzaOven:Check", icon = "fas fa-temperature-high", label = "Use Stone Oven", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzWine", vector3(809.34, -761.84, 22.3), 0.4, 1.7, { name="PizzWine", heading = 0.0, debugPoly=Config.Debug, minZ = 21.3, maxZ = 22.9, }, 
		{ options = { {  event = "jim-pizzathis:Menu:Wine", icon = "fas fa-wine-bottle	", label = "Open Wine Rack", job = "pizzathis" }, }, distance = 1.0 })	
	...
	exports['qb-target']:AddBoxZone("PizzFridge", vector3(814.09, -750.07, 26.78), 0.6, 0.6, { name="PizzFridge", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=26.83 }, 
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-archive", label = "Open Drink Fridge", shop = 1, job = "pizzathis" }, }, distance = 1.5 })	
	...
	exports['qb-target']:AddBoxZone("PizzFridge3", vector3(805.68, -761.62, 26.78), 1.6, 0.6, { name="PizzFridge3", heading = 0.0, debugPoly=Config.Debug, minZ = 25.98, maxZ = 28.18, }, 
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-temperature-low", label = "Open Food Fridge", shop = 2, job = "pizzathis" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzFreezer", vector3(802.75, -756.85, 26.78), 0.6, 4.0, { name="PizzFreezer", heading = 0.0, debugPoly=Config.Debug, minZ = 25.78, maxZ = 28.58, }, 
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-temperature-low", label = "Open Freezer", shop = 3, job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzTap", vector3(814.14, -749.35, 26.78), 0.9, 0.6, { name="PizzTap", heading = 0.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.48, }, 
		{ options = { { event = "jim-pizzathis:Menu:Beer", icon = "fas fa-beer", label = "Pour Beer", job = "pizzathis" }, }, distance = 1.5 })
...
--RegisterNetEvent('jim-pizzathis:toggleDuty', function() onDuty = not onDuty TriggerServerEvent('QBCore:ToggleDuty') end)
...
RegisterNetEvent('jim-pizzathis:Menu:Oven', function()
    exports['qb-menu']:openMenu({
        ...
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["bolognese"].image.." width=35px> "..QBCore.Shared.Items["bolognese"].label.." "..bolognese, txt = "- "..QBCore.Shared.Items["meat"].label.."<br>- "..QBCore.Shared.Items["sauce"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'bolognese' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["calamari"].image.." width=35px> "..QBCore.Shared.Items["calamari"].label.." "..calamari, txt = "- "..QBCore.Shared.Items["squid"].label.."<br>- "..QBCore.Shared.Items["sauce"].label.."<br>- "..QBCore.Shared.Items["pasta"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'calamari' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["meatball"].image.." width=35px> "..QBCore.Shared.Items["meatball"].label.." "..meatball, txt = "- "..QBCore.Shared.Items["meat"].label.."<br>- "..QBCore.Shared.Items["pasta"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'meatball' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["alla"].image.." width=35px> "..QBCore.Shared.Items["alla"].label.." "..alla, txt = "- "..QBCore.Shared.Items["ham"].label.."<br>- "..QBCore.Shared.Items["pasta"].label.."<br>- "..QBCore.Shared.Items["vodka"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'alla' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pescatore"].image.." width=35px> "..QBCore.Shared.Items["pescatore"].label.." "..pescatore, txt = "- "..QBCore.Shared.Items["squid"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'pescatore' } } },
    })
end)
...
RegisterNetEvent('jim-pizzathis:Menu:PizzaBase', function()
    exports['qb-menu']:openMenu({
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pizzabase"].image.." width=35px> "..QBCore.Shared.Items["pizzabase"].label..' '..pizzabase, txt = "- "..QBCore.Shared.Items["pizzadough"].label.."<br>- "..QBCore.Shared.Items["sauce"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'pizzabase' } } },
    })
end)
...
RegisterNetEvent('jim-pizzathis:Menu:PizzaOven', function()
    exports['qb-menu']:openMenu({
        ...
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["margherita"].image.." width=35px> "..QBCore.Shared.Items["margherita"].label.." "..margherita, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'margheritabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["marinara"].image.." width=35px> "..QBCore.Shared.Items["marinara"].label.." "..marinara, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["basil"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'marinarabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["prosciuttio"].image.." width=35px> "..QBCore.Shared.Items["prosciuttio"].label.." "..prosciuttio, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label.."<br>- "..QBCore.Shared.Items["ham"].label.."<br> - "..QBCore.Shared.Items["pizzmushrooms"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'prosciuttiobox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["diavola"].image.." width=35px> "..QBCore.Shared.Items["diavola"].label.." "..diavola, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label.."<br>- "..QBCore.Shared.Items["salami"].label.."<br> - "..QBCore.Shared.Items["basil"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'diavolabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["capricciosa"].image.." width=35px> "..QBCore.Shared.Items["capricciosa"].label.." "..capricciosa, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["ham"].label.."<br>- "..QBCore.Shared.Items["pizzmushrooms"].label.."<br> - "..QBCore.Shared.Items["olives"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'capricciosabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["vegetariana"].image.." width=35px> "..QBCore.Shared.Items["vegetariana"].label.." "..vegetariana, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label.."<br>- "..QBCore.Shared.Items["lettuce"].label.."<br> - "..QBCore.Shared.Items["basil"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'vegetarianabox' } } },
    })
end)
RegisterNetEvent('jim-pizzathis:Menu:Beer', function()
    ...
    exports['qb-menu']:openMenu({
        ...
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["ambeer"].image.." width=35px> "..QBCore.Shared.Items["ambeer"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'ambeer' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["dusche"].image.." width=35px> "..QBCore.Shared.Items["dusche"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'dusche' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["logger"].image.." width=35px> "..QBCore.Shared.Items["logger"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'logger' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pisswasser"].image.." width=35px> "..QBCore.Shared.Items["pisswasser"].label,  params = { event = "jim-pizzathis:JustGive", args = { id = 'pisswasser' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pisswasser2"].image.." width=35px> "..QBCore.Shared.Items["pisswasser2"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'pisswasser2' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pisswasser3"].image.." width=35px> "..QBCore.Shared.Items["pisswasser3"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'pisswasser3' } } },
    })
end)
RegisterNetEvent('jim-pizzathis:Menu:Wine', function()
    ...
    exports['qb-menu']:openMenu({
        ...
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["amarone"].image.." width=35px> "..QBCore.Shared.Items["amarone"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'amarone' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["barbera"].image.." width=35px> "..QBCore.Shared.Items["barbera"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'barbera' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["dolceto"].image.." width=35px> "..QBCore.Shared.Items["dolceto"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'dolceto' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["housered"].image.." width=35px> "..QBCore.Shared.Items["housered"].label,  params = { event = "jim-pizzathis:JustGive", args = { id = 'housered' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["housewhite"].image.." width=35px> "..QBCore.Shared.Items["housewhite"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'housewhite' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["rosso"].image.." width=35px> "..QBCore.Shared.Items["rosso"].label, params = { event = "jim-pizzathis:JustGive", args = { id = 'rosso' } } },
    })
end)
...
RegisterNetEvent('jim-pizzathis:Menu:ChoppingBoard', function()
    exports['qb-menu']:openMenu({
        ...
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["salami"].image.." width=35px> "..QBCore.Shared.Items["salami"].label.." "..salami, txt = "- "..QBCore.Shared.Items["meat"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'salami' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["ham"].image.." width=35px> "..QBCore.Shared.Items["ham"].label.." "..ham, txt = "- "..QBCore.Shared.Items["meat"].label, params = { event = "jim-pizzathis:MakeItem", args = { item = 'ham' } } },
    })
end)

RegisterNetEvent('jim-pizzathis:JustGive', function(data) if not jobCheck() then return else FoodProgress(data.id) end end)
