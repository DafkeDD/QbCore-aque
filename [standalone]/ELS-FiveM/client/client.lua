                ...
                if canControlELS then
                    ...
                    if vehN ~= 0 then
                        ...
                        if (panelType == "original") then
                            ...
                            Draw("INSPIRE", 0, 0, 0, 255, 0.745 + panelOffsetX, 0.825 + panelOffsetY, 0.25, 0.25, 1, true, 0)
                            Draw("standby.eu", 0, 0, 0, 255, 0.92 + panelOffsetX, 0.825 + panelOffsetY, 0.25, 0.25, 1, true, 0)
