...
Config.SmokeontheWaterItems = {                      -- Items sold at Some on the Water shop
    ...
    [2] = { name = "marijuana_scale",           price = 1000, amount = 999, info = {}, type = "item", slot = 2 },
    [3] = { name = "marijuana_rollingpapers",   price = 250, amount = 999, info = {}, type = "item", slot = 3 },
    [4] = { name = "marijuana_lighter",         price = 300, amount = 999, info = {}, type = "item", slot = 4 },
    [5] = { name = "marijuana_trowel",          price = 500, amount = 999, info = {}, type = "item", slot = 5 },
    [6] = { name = "marijuana_phone",           price = 1500, amount = 999, info = {}, type = "item", slot = 6 },
    [7] = { name = "marijuana_water",           price = 100, amount = 999, info = {}, type = "item", slot = 7 },
    [8] = { name = "marijuana_nutrition",       price = 100, amount = 999, info = {}, type = "item", slot = 8 },
    [9] = { name = "coke_empty_bags",       price = 100, amount = 999, info = {}, type = "item", slot = 9 },
}
