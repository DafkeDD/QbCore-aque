...
Citizen.CreateThread(function()
    for k, v in pairs (Config.Stores) do
        if Config.Stores[k].shopType == "clothing" then
            ...
            SetBlipScale  (clothingShop, 0.8)
            SetBlipAsShortRange(clothingShop, true)
            BeginTextCommandSetBlipName("STRING")
            AddTextComponentString("Klädbutik")
                ...
                if dist < 30 then
                    if not creatingCharacter then
                        ...
                        if dist < 3.5 then
                            ...
                            inZone  = true
                            if Config.Stores[k].shopType == "clothing" then 
                                text = '<b>Clothing Shop</b></p>Tryck [E] för menyn'
                            elseif Config.Stores[k].shopType == "barber" then
                                text = '<b>Barber Shop</b></p>Tryck [E] för menyn'
                            elseif Config.Stores[k].shopType == "surgeon" then
                                text = '<b>Plastic Surgery</b></p>Tryck [E] för menyn'
                            end
...
RegisterNetEvent('doj:client:clothingMenu', function()
	exports['qb-menu']:openMenu({
		{
			header = "Klädbutik",
			txt = "Betala med kontanter: $"..Config.Cost.ClothingCash,
            params = {
		...
		{
			header = "Klädbutik",
			txt = "Betala med banken: $"..Config.Cost.ClothingBank,
			params = {
				event = "doj:server:payForClothing",
                isServer = true,
                args = 2
...
RegisterNetEvent('doj:client:barberMenu', function()
	exports['qb-menu']:openMenu({
		{
			header = "Frisör",
			txt = "Betala med kontanter: $"..Config.Cost.BarberCash,
            params = {
		...
		{
			header = "Frisör",
			txt = "Betala med banken: $"..Config.Cost.BarberBank,
			params = {
				event = "doj:server:payForBarber",
                isServer = true,
                args = 2
                    ...
                    if not creatingCharacter then
                        ...
                        if dist < 2 then
                            ...
                            if PlayerData.job.name == Config.ClothingRooms[k].requiredJob then 
                                text = '<b>View Clothing</b></p>Tryck [E] för menyn'
                                if IsControlJustPressed(0, 38) then -- E
...
AddEventHandler('qb-clothing:client:openOutfitMenu', function()
    QBCore.Functions.TriggerCallback('qb-clothing:server:getOutfits', function(result)
        openMenu({
            {menu = "myOutfits", label = "Mina Outfits", selected = true, outfits = result},
        })
    end)
end)
...
RegisterNUICallback('TrackerError', function()
    QBCore.Functions.Notify("Du kan inte ta bort ditt ankelarmband..", "error")
end)
...
RegisterNUICallback('removeOutfit', function(data, cb)
    ...
    QBCore.Functions.Notify("Du har raderat din"..data.outfitName.." outfit!")
end)
...
AddEventHandler('qb-clothing:client:loadOutfit', function(oData)
    ...
    if oData.outfitName ~= nil then
