...
LegacyFuel is a Modified version of LegacyFuel for QB-Core using QB-Target for Interactions.
<br>
...
2. Drop the LegacyFuel folder into your [standalone] folder
...
**Any scripts that use the LegacyFuel export should be changed to use the LegacyFuel export instead.**
<br>
- exports['LegacyFuel'] --> exports['LegacyFuel']
<br>
