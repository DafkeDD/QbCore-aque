Citizen.CreateThread(function()
	...
	OdeonBlip = AddBlipForCoord(Config.BoatSpawnLocation.Odeon)
	SetBlipSprite(OdeonBlip, 410)
	SetBlipDisplay(OdeonBlip, 4)
	SetBlipScale(OdeonBlip, 0.7)
	SetBlipColour(OdeonBlip, 74)
    SetBlipAsShortRange(OdeonBlip, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Fiske")
    EndTextCommandSetBlipName(OdeonBlip)
    ...
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("Sälj Fisk")
