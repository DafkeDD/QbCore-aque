    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Förnamn: </strong><span>" +
                itemData.info.firstname +
                "</span></p><p><strong>Efternamn: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Födelsedatum: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Kön: </strong><span>" +
                gender +
        ...
        } else if (itemData.name == "vehkeys") { 
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>REGNUMMER: '+ itemData.info.label + '</p>');        
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-title").html('<p>'+itemData.label+'</p>')
                $(".item-info-description").html('<p>PLATE: '+ itemData.info.label + '</p>');
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Anstränga: ' + itemData.info.strain + '</p>Potens: ' + itemData.info.potency + '</p>Typ: ' + itemData.info.type + '<p>Thc: ' + itemData.info.thc + '%</p>');
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Art: ' + itemData.info.species + '</p>Vikt: ' + itemData.info.lbs + ' lbs</p>Typ: ' + itemData.info.type);
        } else if (itemData.name == "stingray") {
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Art: ' + itemData.info.species + '</p>Vikt: ' + itemData.info.lbs + ' lbs</p>Typ: ' + itemData.info.type);
        } else if (itemData.name == "arcadeblue") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Owner: </strong>'+itemData.info.owner+'</p><strong>Spelkortstid:</strong> '+itemData.info.cardtime+' minuter</p>'); 
            $(".item-info-stats").html('<p>Vikt: '+((itemData.weight * itemData.amount) / 1000).toFixed(1) +' | Summa: '+itemData.amount+ ' | Kavlite: '+itemData.info.quality.toFixed(0)+'%</p>') 
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p><strong>Namn: </strong><span>'+ itemData.info.firstname + '</span></p><p><strong>Efternamn: </strong><span>'+ itemData.info.lastname+ '</span></p><p><strong>Reggplåt: </strong><span>'+ itemData.info.plate + '<p><strong>Märke: </strong><span>'+ itemData.info.model +'</span></p>');
        } else if (itemData.name == "fishicebox") {
            $(".item-info-title").html('<p>' + itemData.label + ' ' + itemData.info.boxid + '</p>')
            $(".item-info-description").html('<p><strong>Box Ägare: </strong><span>' + itemData.info.boxOwner + '</span></p> Is Box för att lagra all din fisk');
        } else if (itemData.name == "moneybag") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Summa av pengar: </strong><span>$" +
                itemData.info.cash +
                "</span></p>"
            );
        } else if (itemData.name == "vehkeys") { 
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p>Reggplåt: '+ itemData.info.label + '</p>');
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Kortnamn: </strong><span>' + itemData.info.name + '</span></p><p><strong>Medborgar ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Card Number: </strong><span>' + cardNumber + '</span></p>');
...
(() => {
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "Använt " + data.itemAmount + "x";
        if (data.type == "add") {
          type = "Mottagen " + data.itemAmount + "x";
        } else if (data.type == "remove") {
          type = "Borttaget " + data.itemAmount + "x";
        }
