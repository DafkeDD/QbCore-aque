local Translations = {
    error = {
        ["failed_notification"] = "Mislyckades!",
        ...
        ["no_permission"] = "Du har inte behörighet att reparera fordon",
        ["fix_message"] = "%{meddelande}, och gå nu till ett garage!",
        ["veh_damaged"] = "Ditt fordon är för skadat!",
        ["nofix_message_1"] = "Du tittade på din oljenivå och detta såg normalt ut",
    ...
    success = {
        ...
        ["fix_message_1"] = "Du kontrollerade oljenivån",
