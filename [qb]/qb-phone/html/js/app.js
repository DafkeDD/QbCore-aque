    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                ...
                icon = '<img src="./img/apps/annons.png" class="advert-icon">';
            }else if (app.app == "details"){
                icon = '<img src="./img/apps/details.png" class="advert-icon">';
            }else if (app.app == "gallery"){
                icon = '<img src="./img/apps/gallery.png" class="advert-icon">';
            }else if (app.app == "mail"){
                icon = '<img src="./img/apps/mail.png" class="advert-icon">';
            }else if (app.app == "settings"){
                icon = '<img src="./img/apps/settings.png" class="advert-icon">';
            }else if (app.app == "phone"){
                icon = '<img src="./img/apps/phone.png" class="advert-icon">';
            }else if (app.app == "twitter"){
                icon = '<img src="./img/apps/twitter.png" class="advert-icon">';
        ...
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    $("#mySerialNumber").text("DS" + QB.Phone.Data.PlayerData.metadata["phonedata"].SerialNumber);
    ...
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "UpdateCallTime":
                ...
                $(".phone-currentcall-title").html("Pågående samtal ("+timeString+")");
                break;
